...
1. [Sample 2: Secure an API with basic authentication](scenarios/scenario-3)
1. [Sample 3: Secure an API with JWT](scenarios/scenario-4)
1. [Sample 4: Secure an API with OAuth2 tokens](scenarios/scenario-5)
1. [Sample 5: Apply rate limiting for an API](scenarios/scenario-6)
1. [Sample 6: Private jet mode for API and Endpoint](scenarios/scenario-7)
1. [Sample 7: Sidecar mode for API and Endpoint](scenarios/scenario-8)
