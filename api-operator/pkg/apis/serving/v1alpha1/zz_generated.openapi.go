...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"./pkg/apis/serving/v1alpha1.Service":       schema_pkg_apis_serving_v1alpha1_Service(ref),
		"./pkg/apis/serving/v1alpha1.ServiceSpec":   schema_pkg_apis_serving_v1alpha1_ServiceSpec(ref),
		"./pkg/apis/serving/v1alpha1.ServiceStatus": schema_pkg_apis_serving_v1alpha1_ServiceStatus(ref),
	}
}
...
func schema_pkg_apis_serving_v1alpha1_Service(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/serving/v1alpha1.ServiceSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/serving/v1alpha1.ServiceStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"./pkg/apis/serving/v1alpha1.ServiceSpec", "./pkg/apis/serving/v1alpha1.ServiceStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_serving_v1alpha1_ServiceSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"template": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("./pkg/apis/serving/v1alpha1.RevisionTemplateSpec"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"./pkg/apis/serving/v1alpha1.RevisionTemplateSpec"},
	}
}
