...
Implementation of the ratelimiting controller is found [here](https://github.com/wso2/k8s-api-operator/blob/master/apim-operator/pkg/controller/ratelimiting/ratelimiting_controller.go)
