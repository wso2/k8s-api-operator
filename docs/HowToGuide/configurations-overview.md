...
- You have to configure these credentials in 2 files.
    ...
    1. Open \<k8s-api-operator-home>/apim-operator/controller-configs/controller_conf.yaml
    ...
    2. Open \<k8s-api-operator-home>apim-operator/controller-configs/docker_secret_template.yaml
...
- Open \<k8s-api-operator-home>/apim-operator/controller-configs/controller_conf.yaml
...
- These configurations reside in the \<k8s-api-operator-home>/apim-operator/controller-configs/controller_conf.yaml
